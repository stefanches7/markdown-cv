...
Java (3 years), Python (3 years),  Javascript (2 years), Julia (2 years), C (1 year), Keras (2 years), R (2 years), Bash, SQL, Git, SCRUM, Machine Learning, Teamwork

## Work experience

`08.2022-11.2022`	
Neuroscience Application Developer placement at <br> __Georgia State University, USA__ 
- • Simulation runs with MATLAB on HPC and documentation of group fMRI analysis to ease users acquisition.
<hr>
`07.2022-08.2022`	
Computational Neuroscientist placement at <br> __Aston University, UK__ 
- • Modified Transfer Entropy measurement mathematically to avoid bias using Julia.
<hr>
`08.2021-06.2022`
...
-  • I have developed BCI tasks like Motor Imagery for EEG device application using MATLAB.
<hr>
`10.2020-03.2021`
IT Architecture Developer at __STABL GmbH__
-  • Improved the remote control of battery racks with Javascript and code quality in the company with SonarQube/Docker, <br> which saved maintenance costs by 70%.
<hr>
`05.2019-08.2019`
Google Summer of Code '19 Student with __International Neuroinformatics Coordination Facility__
- • Trained Machine Learning capable agents for Cognitive Science experiments with Java/Kotlin.
<hr>
`01.2018-09.2020`
Assistant Researcher at the __Chair for Computational Biology__, TUM
- • Performed sequencing data analysis/QC with Python, developed ML models and investigated <br> new scientific niches.
<hr>
`05.2017-08.2017`
Google Summer of Code with __European Bioinformatics Institute, EMBL__, Cambrige, UK
- • Speeded up file search with a SpringBoot/React.js server by 153% for ca. 63 millions daily web requests.
<hr>
`01.2017-08.2017`	 
